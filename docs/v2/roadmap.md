...
| 2.1 | 消息加密 | 3 周 | 无 |
| 2.2 | 消息智能审核 | 2 周 | 2.1 |
| **3** | **授权与生态扩展** | **6 周** | ✅ **完成** (3.6 延后) | Phase 1 |
| 3.1 | 外部应用注册 | 1 周 | ✅ 完成 | 无 |
| 3.2 | OAuth 2.0 + 身份映射 | 1.5 周 | ✅ 完成 | 3.1 |
| 3.3 | 出站 Webhook | 1.5 周 | ✅ 完成 | 无 |
| 3.4 | 自定义 WS 事件 | 1 周 | ✅ 完成 | 无 |
| 3.5 | 房间-资源绑定 | 0.5 周 | ✅ 完成 | 3.1 |
| 3.6 | SSO 社交登录 | 0.5 周 | ⏸️ 延后 | Phase 1 |
| | **合计** | **~15 周** | |
